...
The full harness last passed on **2026-08-25** for the title-story and robot-clearance maintenance candidate using `Godot 4.7.2.stable.official.ed1daf0bf`.

| Check | Result |
|---|---|
| Harness command | `./verify.sh --full` |
| Process result | Exit `0`; `[VERIFY-PASS] mode=full` |
| GUT suite | 50 scripts; 296 of 296 tests passed; 28,672 assertions |
...
| PCK size | 13,823,212 bytes, below the 16 MiB harness limit |
