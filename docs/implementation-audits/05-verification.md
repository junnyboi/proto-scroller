...
6. Manual review is additive, not a substitute: inspect hybrid-horror readability, Chinese layout, and Web audio/video behavior, then approve the already-green immutable artifact.
