...
**Author:** Manus AI | **Status:** Approved and in progress | **Target engine:** Godot 4.7.2 stable
...
| Finale | `ChoirPrimeSession` is additive beside the existing command-boss implementation. It latches Royal arrival and arc completion, activates five fixed pylons and one core, then requests a choice. |
