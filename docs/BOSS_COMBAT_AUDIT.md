...
**How to take it down:** Damage the armor with any weapon while crossing the open lanes, then continue with any normal damage source against the exposed body. Each accepted hit produces a brief white flash and updates the compact yellow/red bars. Use the full space left of the right arena boundary; it vanishes into the explosion-and-fireworks barrage when the body fails. Ground-smash the labeled wreck target for the completion record.[1][3][10][12]
