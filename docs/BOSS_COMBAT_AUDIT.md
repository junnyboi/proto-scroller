...
|---|---|---|
| **Armored** | **Assessment Levy** telegraphs and releases one fast pressure front; **Double-Entry Rupture** previews and releases two fronts 0.30 seconds apart. Each recovery summons four foot soldiers until eight are active, replacing casualties without exceeding the cap. | Use any melee or equipped weapon. Ground smash, tap jab-cross, bullets, shells, rockets, and impact damage all reduce armor by their actual accepted amount. Read the ghost-ring count, then cross each visible front with movement or a timed dodge. |
| **Exposed** | Double-Entry Rupture alternates with **Compound Default**, whose three visible fronts release at 0.24-second intervals and travel farther across the road. | Clear soldiers when they crowd the approach, preserve the dodge for the disclosed front cadence, then attack the exposed body during recovery. |
| **Final third** | Compound Default leads the rotation and alternates with the double wave. Front damage still scales through the global enemy multiplier in New Game+. | Reposition during the accelerating red-white telegraph; commit to consecutive evasions only as the individually visible fronts arrive. |
...
**How to take it down:** Damage the armor with any weapon, then continue with any normal damage source against the exposed body. Each accepted hit produces a brief white flash and updates the compact yellow/red bars. The amber range rail and one, two, or three ghost rings reveal the exact coming pattern; the white-gold pressure fronts become dangerous only after release. Cross them with movement or the 0.30-second dodge window, then use recovery to damage S-04 or thin the incoming soldiers. Strike the darkened boss corpse once with a fresh melee; its rubble settles on the road divider before the completion record and repair drop.[1][3][10][12]
