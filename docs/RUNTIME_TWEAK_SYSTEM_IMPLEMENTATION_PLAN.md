...
| WP5 | In progress | — | Dense scroll-first UI, typed color controls, and six visual-only adapters implemented; focused release evidence pending final shared-main revision. |
| WP6 | Pending | — | — |
