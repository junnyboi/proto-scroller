...
const GAME_PACK_VERSION = "dfe0bce1";
const REMOTE_ENGINE_PATH = "/manus-storage/game_4ce4eb3e";
const REMOTE_PACK_PATH = `/manus-storage/game_d4ef2dac.pck?v=${GAME_PACK_VERSION}`;
const ENGINE_WASM_BYTES = 39_513_091;
const GAME_PACK_BYTES = 8_234_724;
