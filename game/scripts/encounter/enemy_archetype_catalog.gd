...
const PROFILES: Dictionary = {
	&"needle": {
		...
		"preferred_range": 560.0, "minimum_range": 390.0, "attack_interval": 2.8,
		"projectile_kind": &"bullet", "projectile_speed": 760.0, "damage": 4.0,
		"anticipation": 0.8, "behavior": &"air_standoff", "movement_style": &"drone_hover",
	...
	&"bulwark": {
		...
		"preferred_range": 230.0, "minimum_range": 120.0, "attack_interval": 1.7,
		"projectile_kind": &"bullet", "projectile_speed": 690.0, "damage": 6.0,
		"anticipation": 0.55, "behavior": &"ground_standoff", "movement_style": &"shield_march",
	...
	&"jackal": {
		...
		"preferred_range": 340.0, "minimum_range": 170.0, "attack_interval": 1.3,
		"projectile_kind": &"bullet", "projectile_speed": 820.0, "damage": 5.0,
		"anticipation": 0.45, "behavior": &"ground_pass", "movement_style": &"wheel_sprint",
	...
	&"lobber": {
		...
		"spawn_y": 542.0, "health": 80.0, "speed": 82.0, "acceleration": 500.0,
		"preferred_range": 500.0, "minimum_range": 300.0, "attack_interval": 2.2,
		"projectile_kind": &"shell", "projectile_speed": 410.0, "damage": 12.0,
		"anticipation": 0.9, "behavior": &"ground_standoff", "movement_style": &"heavy_march",
	...
	&"sapper": {
		...
		"spawn_y": 541.0, "health": 100.0, "speed": 76.0, "acceleration": 470.0,
		"preferred_range": 420.0, "minimum_range": 240.0, "attack_interval": 2.5,
		"projectile_kind": &"bullet", "projectile_speed": 670.0, "damage": 5.0,
		"anticipation": 0.7, "behavior": &"support", "movement_style": &"utility_march",
	...
	&"hound": {
		...
		"spawn_y": 230.0, "health": 120.0, "speed": 235.0, "acceleration": 520.0,
		"preferred_range": 250.0, "minimum_range": 110.0, "attack_interval": 1.45,
		"projectile_kind": &"bullet", "projectile_speed": 850.0, "damage": 8.0,
		"anticipation": 0.45, "behavior": &"air_close", "movement_style": &"hunter_lunge",
	...
	&"mule": {
		...
		"preferred_range": 450.0, "minimum_range": 280.0, "attack_interval": 2.6,
		"projectile_kind": &"bullet", "projectile_speed": 720.0, "damage": 7.0,
		"anticipation": 0.7, "behavior": &"carrier", "movement_style": &"apc_roll",
	...
	&"basilisk": {
		...
		"preferred_range": 690.0, "minimum_range": 430.0, "attack_interval": 3.1,
		"projectile_kind": &"shell", "projectile_speed": 470.0, "damage": 18.0,
		"anticipation": 1.1, "behavior": &"ground_standoff", "movement_style": &"tracked_heavy",
	...
	&"lancer": {
		...
		"spawn_y": 547.5, "health": 120.0, "speed": 58.0, "acceleration": 350.0,
		"preferred_range": 650.0, "minimum_range": 390.0, "attack_interval": 3.0,
		"projectile_kind": &"rocket", "projectile_speed": 520.0, "damage": 24.0,
		"anticipation": 1.1, "behavior": &"ground_standoff", "movement_style": &"team_shuffle",
	...
	&"static": {
		...
		"preferred_range": 570.0, "minimum_range": 370.0, "attack_interval": 2.4,
		"projectile_kind": &"bullet", "projectile_speed": 700.0, "damage": 4.0,
		"anticipation": 0.65, "behavior": &"support", "movement_style": &"antenna_sway",
	...
	&"kestrel": {
		...
		"spawn_y": 145.0, "health": 130.0, "speed": 285.0, "acceleration": 580.0,
		"preferred_range": 360.0, "minimum_range": 160.0, "attack_interval": 2.5,
		"projectile_kind": &"rocket", "projectile_speed": 430.0, "damage": 16.0,
		"anticipation": 0.75, "behavior": &"air_pass", "movement_style": &"bomber_bank",
	...
	&"rainmaker": {
		...
		"spawn_y": 544.0, "health": 260.0, "speed": 48.0, "acceleration": 210.0,
		"preferred_range": 720.0, "minimum_range": 450.0, "attack_interval": 3.4,
		"projectile_kind": &"rocket", "projectile_speed": 500.0, "damage": 22.0,
		"anticipation": 1.25, "behavior": &"ground_standoff", "movement_style": &"tracked_heavy",
	...
	&"shrike": {
		...
		"spawn_y": 195.0, "health": 180.0, "speed": 260.0, "acceleration": 550.0,
		"preferred_range": 390.0, "minimum_range": 180.0, "attack_interval": 1.9,
		"projectile_kind": &"rocket", "projectile_speed": 560.0, "damage": 16.0,
		"anticipation": 0.65, "behavior": &"air_pass", "movement_style": &"vtol_strafe",
	...
	&"cinder": {
		...
		"spawn_y": 547.0, "health": 320.0, "speed": 68.0, "acceleration": 290.0,
		"preferred_range": 220.0, "minimum_range": 90.0, "attack_interval": 1.25,
		"projectile_kind": &"shell", "projectile_speed": 330.0, "damage": 15.0,
		"anticipation": 0.75, "behavior": &"ground_close", "movement_style": &"flame_lurch",
	...
	&"aegis": {
		...
		"preferred_range": 500.0, "minimum_range": 320.0, "attack_interval": 2.8,
		"projectile_kind": &"bullet", "projectile_speed": 680.0, "damage": 5.0,
		"anticipation": 0.8, "behavior": &"support", "movement_style": &"dish_pulse",
	...
	&"longbow": {
		...
		"preferred_range": 760.0, "minimum_range": 500.0, "attack_interval": 4.0,
		"projectile_kind": &"shell", "projectile_speed": 980.0, "damage": 34.0,
		"anticipation": 1.45, "behavior": &"ground_standoff", "movement_style": &"capacitor_roll",
	...
	&"hive": {
		...
		"spawn_y": 185.0, "health": 360.0, "speed": 118.0, "acceleration": 270.0,
		"preferred_range": 600.0, "minimum_range": 400.0, "attack_interval": 3.0,
		"projectile_kind": &"rocket", "projectile_speed": 500.0, "damage": 12.0,
		"anticipation": 0.9, "behavior": &"carrier", "movement_style": &"carrier_hover",
	...
	&"goliath": {
		...
		"spawn_y": 485.0, "health": 700.0, "speed": 52.0, "acceleration": 210.0,
		"preferred_range": 550.0, "minimum_range": 300.0, "attack_interval": 3.3,
		"projectile_kind": &"shell", "projectile_speed": 600.0, "damage": 28.0,
		"anticipation": 1.2, "behavior": &"ground_standoff", "movement_style": &"walker_stride",
	...
	&"nemesis": {
		...
		"spawn_y": 482.5, "health": 1000.0, "speed": 135.0, "acceleration": 520.0,
		"preferred_range": 180.0, "minimum_range": 70.0, "attack_interval": 1.35,
		"projectile_kind": &"shell", "projectile_speed": 760.0, "damage": 26.0,
		"anticipation": 0.65, "behavior": &"ground_close", "movement_style": &"mech_stride",
	...
	&"leviathan": {
		...
		"spawn_y": 505.0, "health": 2500.0, "speed": 34.0, "acceleration": 150.0,
		"preferred_range": 660.0, "minimum_range": 380.0, "attack_interval": 2.8,
		"projectile_kind": &"rocket", "projectile_speed": 560.0, "damage": 30.0,
		"anticipation": 1.3, "behavior": &"ground_standoff", "movement_style": &"landship_rumble",
