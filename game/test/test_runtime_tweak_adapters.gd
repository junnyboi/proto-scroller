...
func test_next_run_progression_spawn_and_shop_adapters_share_one_snapshot() -> void:
	...
	assert_eq(RunExperience.required_for_level(1), 600 * RunExperience.REQUIREMENT_MULTIPLIER)
	assert_eq(RunExperience.required_for_level(2), 900 * RunExperience.REQUIREMENT_MULTIPLIER)
